...
try:
    from .core_map import FREE, OCCUPIED, UNKNOWN, neighbors4, sensor_cells
...
def _removed_unknownmap_frontier_helper(*_args, **_kwargs):
    raise RuntimeError(
        "Legacy unknown-map frontier helpers were removed from the known-map mainline. "
        "See baseline_GP/legacy.md for archived code."
    )


find_frontiers = _removed_unknownmap_frontier_helper
frontier_gain = _removed_unknownmap_frontier_helper
