"""Audit for Phase 5D-13 live RGB/RangeFinder sync fix."""
...
ADAPTER_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d13_adapter_observe_trace.json")
UPDATE_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d13_mainline_update_found_trace.json")
RAW_FRAME_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d13_raw_frame_sync_diagnostic.json")
...
PROBE_SCRIPT = os.path.join(PHASE_DIR, "scripts", "live_rgb_range_sync_fix_probe.py")
AUDIT_SCRIPT = os.path.join(PHASE_DIR, "scripts", "live_rgb_range_sync_fix_audit.py")

AUDIT_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d13_audit.json")
AUDIT_MD = os.path.join(PHASE_DIR, "reports", "phase5d13_audit_summary.md")
...
def _build_audit() -> Dict[str, Any]:
    ...
    checks["rgb_sync_fix_enabled_and_used"] = (
        ...
        and summary.get("rgb_range_sync_strategy") == "short_window_detector_scored_nearest_pair"
    ...
    checks["original_update_found_mask_closed_all_found"] = (
        ...
        and summary.get("target_all_found_step") == 16
