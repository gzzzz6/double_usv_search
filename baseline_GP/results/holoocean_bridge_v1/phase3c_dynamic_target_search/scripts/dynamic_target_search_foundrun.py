...
DECISIONS_JSON  = os.path.join(PHASE_DIR, "manifests", "dynamic_target_search_foundrun_decisions.json")
DECISIONS_CSV   = os.path.join(PHASE_DIR, "manifests", "dynamic_target_search_foundrun_decisions.csv")
TICK_CSV        = os.path.join(PHASE_DIR, "manifests", "dynamic_target_search_foundrun_tick_trace.csv")
TARGET_JSON     = os.path.join(PHASE_DIR, "manifests", "dynamic_target_search_foundrun_target_trace.json")
TARGET_CSV      = os.path.join(PHASE_DIR, "manifests", "dynamic_target_search_foundrun_target_trace.csv")
FOUND_JSON      = os.path.join(PHASE_DIR, "manifests", "dynamic_target_search_foundrun_found_events.json")
SUMMARY_MD      = os.path.join(PHASE_DIR, "reports",   "dynamic_target_search_foundrun_summary.md")
PREVIEW_PNG     = os.path.join(PHASE_DIR, "visuals",   "dynamic_target_search_foundrun_route_map.png")
...
def generate_trajectory_preview(
    ...
    try:
        ...
        schedule_cells = [(20, 20), (20, 25), (25, 25), (25, 30), (30, 30), (35, 35)]
...
def main() -> None:
    print("=== Phase 3C-1-found: Launching Single-USV Dynamic Target Search ===")
    ...
    scenario_cfg = {
        "name": "dynamic_target_search_foundrun",
        "world": spec["world"],
    ...
    found_events = {
        ...
        "run_label": "dynamic_target_search_foundrun",
        "phase_note": "Phase 3C-1-found dynamic target search found-attempt run; OpenWater, target agent proxy, no HoloOcean sonar/camera."
    }
