# Dynamic Target Search Audit Report - Phase 3C-1-catchable
 
## Audit Summary
- **Overall Result**: `PASSED`
- **Failures Count**: `0`
- **Note**: `catchable run did not trigger probabilistic detection`
...
| Run Label OK | `PASSED` | run_label is dynamic_target_search_catchable |
...
| Catchable Schedule Compliance | `PASSED` | Contains (25,30) staying after step 46 |
