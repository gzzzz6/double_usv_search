"""Audit for Phase 5D-14 continuous rolling RGB/RangeFinder sync."""
...
ADAPTER_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d14_adapter_observe_trace.json")
UPDATE_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d14_mainline_update_found_trace.json")
RAW_FRAME_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d14_raw_frame_sync_diagnostic.json")
...
PROBE_SCRIPT = os.path.join(PHASE_DIR, "scripts", "continuous_rolling_rgb_rf_sync_probe.py")
AUDIT_SCRIPT = os.path.join(PHASE_DIR, "scripts", "continuous_rolling_rgb_rf_sync_audit.py")

AUDIT_JSON = os.path.join(PHASE_DIR, "manifests", "phase5d14_audit.json")
AUDIT_MD = os.path.join(PHASE_DIR, "reports", "phase5d14_audit_summary.md")
...
def _build_audit() -> Dict[str, Any]:
    ...
    checks["rgb_sync_fix_enabled_and_used"] = (
        ...
        and summary.get("rgb_range_sync_strategy") == "continuous_rolling_detector_scored_nearest_pair"
...
def _write_audit_md(audit: Dict[str, Any]) -> None:
    ...
    lines = [
        "# Phase 5D-14 Continuous Rolling RGB/RF Sync Audit",
        "",
