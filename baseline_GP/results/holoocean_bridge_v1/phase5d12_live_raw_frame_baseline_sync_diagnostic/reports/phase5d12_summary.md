...
Phase 5D-12 is a raw-frame diagnostic: it exercises the real planner callback and live HoloOcean capture path, saves selected target/baseline RGB evidence, and does not by itself claim the HoloOcean real search all_found chain is closed.
