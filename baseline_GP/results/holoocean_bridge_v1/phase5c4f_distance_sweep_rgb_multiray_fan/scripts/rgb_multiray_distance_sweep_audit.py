"""Audit for Phase 5C-4F distance sweep."""
...
PROBE_SCRIPT = os.path.join(PHASE_DIR, "scripts", "rgb_multiray_distance_sweep_probe.py")
AUDIT_SCRIPT = os.path.join(PHASE_DIR, "scripts", "rgb_multiray_distance_sweep_audit.py")
CONFIG_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_config.json")
SCENE_RESULTS_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_scene_results.json")
EVENTS_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_detection_events.json")
TICK_TRACE_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_tick_trace.json")
TICK_TRACE_CSV = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_tick_trace.csv")
MATRIX_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_matrix.json")
MATRIX_CSV = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_matrix.csv")
SUMMARY_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_summary.json")
GIT_STATUS_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_git_status.json")
SUMMARY_MD = os.path.join(PHASE_DIR, "reports", "rgb_multiray_distance_sweep_summary.md")
OVERVIEW_PNG = os.path.join(PHASE_DIR, "reports", "rgb_multiray_distance_sweep_overview.png")
AUDIT_JSON = os.path.join(PHASE_DIR, "manifests", "rgb_multiray_distance_sweep_audit.json")
AUDIT_MD = os.path.join(PHASE_DIR, "reports", "rgb_multiray_distance_sweep_audit_summary.md")
BASE_COMPILE_LOG = os.path.join(PHASE_DIR, "logs", "rgb_multiray_distance_sweep_py_compile_base.txt")
HOLO_COMPILE_LOG = os.path.join(PHASE_DIR, "logs", "rgb_multiray_distance_sweep_py_compile_holo.txt")
...
def _build_md(checks: Dict[str, bool], metrics: Dict[str, Any]) -> str:
    lines = [
        "# Phase 5C-4F Distance Sweep Audit Summary",
        "",
...
def main() -> None:
    ...
    expected_distances = [10.0, 15.0, 20.0, 25.0, 30.0]
    ...
    checks["compiled_expected_scripts"] = (
        "rgb_multiray_distance_sweep_probe.py" in _read(BASE_COMPILE_LOG)
        and "rgb_multiray_distance_sweep_audit.py" in _read(BASE_COMPILE_LOG)
        and "rgb_multiray_distance_sweep_probe.py" in _read(HOLO_COMPILE_LOG)
        and "rgb_multiray_distance_sweep_audit.py" in _read(HOLO_COMPILE_LOG)
    )
    ...
    print("Phase 5C-4F audit finished: all_passed={0}".format(audit["all_passed"]))
